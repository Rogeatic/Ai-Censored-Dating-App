...
#      target.build_configurations.each do |config|
#        config.build_settings['OTHER_LDFLAGS'] = '-ObjC -force_load $(BUILT_PRODUCTS_DIR)/GoogleSignIn/GoogleSignIn.framework/GoogleSignIn -force_load $(BUILT_PRODUCTS_DIR)/JitsiMeetSDK/JitsiMeetSDK.framework/JitsiMeetSDK'
#      end
#    end
#  end
#end
